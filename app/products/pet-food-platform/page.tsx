...
export default function PetFoodPlatformPage() {
  return (
    <main>
      <header>
        <Link className="logo" href="/" aria-label="Volver a MUNOP">
          <b>µ</b>NOP
        </Link>
      ...
      <section className="hero" id="top">
        ...
        <div className="product-stage">
          ...
          <div className="machine">
            <div className="machine-brand"><b>µ</b>NOP</div>
      ...
      <section className="manifesto" id="platform">
        <aside>
          <span>001</span>
          <p>MUNOP<br />PET FOOD PLATFORM</p>
        </aside>
        <div>
          <p className="kicker">WHAT WE ARE BUILDING</p>
          <h2>TECNOLOGÍA QUE SALE DEL CÓDIGO Y <em>ENTRA AL MUNDO REAL.</em></h2>
      ...
      <section className="operation">
        <div className="operation-title">
          ...
          <h2>SIMPLE<br />OUTSIDE.<br /><span>ENGINEERING</span><br />INSIDE.</h2>
        </div>
        <div className="steps">
      ...
      <section className="prototype">
        <div className="prototype-code">
          <span>PROTOTYPE_STATUS</span><strong>FUNCTIONAL</strong>
          <span>ENCLOSURE_STATUS</span><strong>IN DEVELOPMENT</strong>
          <span>COMMERCIAL_STATUS</span><strong>VALIDATION</strong>
        </div>
        <div>
          <p className="kicker">REAL PROTOTYPE / CURRENT STATE</p>
          <h2>THE MACHINE<br />ALREADY <span>EXISTS.</span></h2>
          <p>
      ...
      <section className="pilot" id="pilot">
        ...
        <h2>BUSCAMOS EL<br /><span>PRIMER LUGAR</span><br />DONDE PROBARLO.</h2>
        <p>
      ...
      <footer>
        <Link className="logo footer-logo" href="/"><b>µ</b>NOP</Link>
        <p>PRODUCT / 001 · PET FOOD PLATFORM</p>
        <a href="mailto:contacto@munop.cl">contacto@munop.cl</a>
        <small>PROTOTYPE & COMMERCIAL VALIDATION</small>
      </footer>
    </main>
  );
}
