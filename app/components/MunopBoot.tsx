...
export default function MunopBoot() {
  ...
  return (
    <div
      className={`munop-boot${exiting ? " munop-boot--exit" : ""}`}
      aria-label="MUNOP"
      role="status"
    >
      ...
      <div className="boot-center">
        ...
        <div className="boot-systems" aria-hidden="true">
          <span className="boot-system boot-system--1">SISTEMAS</span>
          <i />
          <span className="boot-system boot-system--2">ROBÓTICA</span>
          <i />
          <span className="boot-system boot-system--3">SOFTWARE</span>
          <i />
          <span className="boot-system boot-system--4">MASCOTAS</span>
        </div>

        <div className="boot-ready" aria-hidden="true">
          <span className="boot-ready__dot" />
          SYSTEM READY
        </div>

        <div className="nop-phase" aria-hidden="true">
          <div className="nop-watermark">
            <span className="nop-watermark__mu">µ</span>NOP
          </div>
